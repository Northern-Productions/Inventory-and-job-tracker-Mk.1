-- Film allocation lock priority:
-- - physical boxes expose allocatable-now vs placeholder reservations
-- - backfill feet_available on physical boxes to mean allocatable-now
-- - reconcile allocation/job write paths through ACL wrappers
