...
const readHandlers: Record<string, ReadHandler> = {
  ...
  "/reports/warehouse-asset-audit": async ({ client, orgId, params, identity }, deps) => {
    return ok(await deps.buildWarehouseAssetAudit(client, orgId, params, identity));
  },
