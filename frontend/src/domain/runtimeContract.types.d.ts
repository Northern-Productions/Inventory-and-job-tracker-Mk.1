declare module './runtimeContract.mjs' {
  ...
  export const JOB_STATUSES: readonly ['READY', 'ORDERED', 'FILM_ORDER', 'COMPLETED', 'CANCELLED'];
  export const ALLOCATION_JOB_STATUSES: readonly ['READY', 'ORDERED', 'FILM_ORDER', 'COMPLETED', 'CANCELLED'];
