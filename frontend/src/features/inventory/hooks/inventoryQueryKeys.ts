...
export const inventoryKeys = {
  ...
  ownerCompaniesRoot: ['inventory', 'owner-companies'] as const,
  ownerCompanies: (params: { includeInactive?: boolean } = {}) =>
    ['inventory', 'owner-companies', params] as const,
  ...
  upsertOwnerCompanyMutation: ['inventory', 'mutation', 'owner-company-upsert'] as const,
  deactivateOwnerCompanyMutation: ['inventory', 'mutation', 'owner-company-deactivate'] as const,
  changeFilmBoxOwnerMutation: ['inventory', 'mutation', 'film-box-owner-change'] as const,
  changeCaulkStockOwnerMutation: ['inventory', 'mutation', 'caulk-stock-owner-change'] as const,
  bulkOwnershipTransferMutation: ['inventory', 'mutation', 'bulk-ownership-transfer'] as const,
  ...
  setJobPhaseStateMutation: ['inventory', 'mutation', 'set-job-phase-state'] as const,
  ...
  correctFilmOrderReceiptMutation: ['inventory', 'mutation', 'correct-film-order-receipt'] as const,
