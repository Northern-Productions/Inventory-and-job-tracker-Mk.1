param(
  [string]$ResolvedCsvPath = "backend/migration-dry-runs/il-assigned/boxes_raw_resolved_with_widths.csv",
  [string]$RemainingExceptionsCsvPath = "backend/migration-dry-runs/il-assigned/boxes_exceptions_remaining.csv",
  [string]$ManualResolutionLogPath = "backend/migration-dry-runs/il-assigned/exception_manual_resolutions.csv",
  [string]$SummaryJsonPath = "backend/migration-dry-runs/il-assigned/missing_quantity_zeroed_summary.json"
)
