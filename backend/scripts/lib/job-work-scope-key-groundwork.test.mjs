...
test('work scope key groundwork migration order precedes final duplicate enablement', async () => {
  ...
  assert.equal(backendMigrations.at(-10), '0134_caulk_read_jobid_scope_projection.sql');
  ...
  assert.equal(supabaseMigrations.at(-10), '20260514030000_caulk_read_jobid_scope_projection.sql');
