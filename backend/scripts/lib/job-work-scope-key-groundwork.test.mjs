...
test('work scope key groundwork migration order precedes final duplicate enablement', async () => {
  ...
  assert.equal(backendMigrations.at(-18), '0134_caulk_read_jobid_scope_projection.sql');
  assert.equal(backendMigrations.at(-17), '0135_job_work_scope_key_groundwork.sql');
  assert.equal(backendMigrations.at(-16), '0136_enable_job_number_work_scope_uniqueness.sql');
  ...
  assert.equal(supabaseMigrations.at(-18), '20260514030000_caulk_read_jobid_scope_projection.sql');
  assert.equal(supabaseMigrations.at(-17), '20260518010000_job_work_scope_key_groundwork.sql');
  assert.equal(supabaseMigrations.at(-16), '20260518020000_enable_job_number_work_scope_uniqueness.sql');
